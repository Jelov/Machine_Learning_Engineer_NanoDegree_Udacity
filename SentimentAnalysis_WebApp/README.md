Machine Learning Deployment using AWS SageMakek
...
SageMaker Project.ipynb : Main Jupter-notebook to develpo ML model and Deploy the web app
index.html : web page to accept user input text for sentiment analysis
train.py : train the model used for this project (LSTMClassifier)
predict.py : load model for predict sentiment analysis result
